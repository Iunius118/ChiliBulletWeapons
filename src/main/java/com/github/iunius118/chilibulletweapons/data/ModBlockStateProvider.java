...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private ResourceLocation generateChiliPepperPotModel() {
        ResourceLocation modelLocation = ChiliBulletWeapons.makeId("block/chili_pepper_pot");
    ...
    private void createPottedChiliPepperModel(Block block, ResourceLocation potModel) {
        ...
        this.simpleBlock(block, models().withExistingParent(blockId.toString(), potModel).texture("plant", blockId.withPrefix("block/")));
    }
