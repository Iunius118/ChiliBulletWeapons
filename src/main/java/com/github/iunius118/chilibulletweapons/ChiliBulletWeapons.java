...
public class ChiliBulletWeapons {
    ...
    private void registerCompostableItems() {
        ...
        ComposterBlock.COMPOSTABLES.put(ModItems.CURVED_GREEN_CHILI, 0.3F);
        ...
        ComposterBlock.COMPOSTABLES.put(ModItems.PICKLED_GREEN_CHILI, 0.3F);
        ...
        ComposterBlock.COMPOSTABLES.put(ModItems.CHILI_CHOCOLATE, 0.3F);
    }
