...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    private void registerGunModels(String gun, String pistol, String rifle, String shotgun) {
        ...
        getBuilder(gun).parent(parent)
                ...
                .override()
                    .predicate(ChiliBulletGun.PROPERTY_PIERCING, 1F).predicate(ChiliBulletGun.PROPERTY_LOADING, 1F)
                ...
                .override()
                    .predicate(ChiliBulletGun.PROPERTY_MULTISHOT, 1F).predicate(ChiliBulletGun.PROPERTY_LOADING, 1F)
