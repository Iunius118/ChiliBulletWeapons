...
public class UpgradeGunBarrel extends AbstractUpgradeGunPart {
    ...
    public boolean canUpgrade(ItemStack itemStack) {
        int multishot = itemStack.getEnchantmentLevel(Enchantments.MULTISHOT);
        int piercing = itemStack.getEnchantmentLevel(Enchantments.PIERCING);
    ...
    public ItemStack upgrade(ItemStack itemStack) {
        ...
        final int piercing = itemStack.getEnchantmentLevel(Enchantments.PIERCING);
