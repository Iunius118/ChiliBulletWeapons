...
public class ModDataComponents {
     ...
     */
    public static final DataComponentType<Unit> LOADING =
     ...
     */
    public static  final DataComponentType<GunContents> GUN_CONTENTS =
            new DataComponentType.Builder<GunContents>()
     ...
     */
    public static final DataComponentType<Unit> FIXED =
            new DataComponentType.Builder<Unit>()
                    .persistent(Unit.CODEC)
                    .networkSynchronized(StreamCodec.unit(Unit.INSTANCE))
                    .build();
     ...
     */
    public static final DataComponentType<DyedGunColors> DYED_GUN_COLORS =
            new DataComponentType.Builder<DyedGunColors>()
