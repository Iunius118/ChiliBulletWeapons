...
public class ModFoods {
    public static final FoodProperties PICKLED_GREEN_CHILI = new FoodProperties.Builder().nutrition(2).saturationMod(0.6F)
            .effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, 600), 1.0F).alwaysEat().fast().build();
    ...
    public static final FoodProperties PASTA_OIL_AND_CHILI = new FoodProperties.Builder().nutrition(6).saturationMod(0.6F).build();
    public static final FoodProperties FRIED_CHILI_PEPPER = new FoodProperties.Builder().nutrition(2).saturationMod(0.6F)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 600), 1.0F).alwaysEat().fast().build();
    public static final FoodProperties CHILI_CHOCOLATE = new FoodProperties.Builder().nutrition(2).saturationMod(0.6F)
            .effect(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 600), 1.0F).alwaysEat().fast().build();
    public static final FoodProperties CHILI_CHOCOLATE_CHICKEN = new FoodProperties.Builder().nutrition(8).saturationMod(0.8F).build();
}
