...
public class UpgradedChiliBulletGunTrigger extends
        SimpleCriterionTrigger<UpgradedChiliBulletGunTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player, Optional<ItemPredicate> item)
        ...
        public static Criterion<TriggerInstance> upgradedChiliBulletGun(HolderGetter<Item> items, ItemLike item) {
            return upgradedChiliBulletGun(ItemPredicate.Builder.item().of(items, item).build());
        }
