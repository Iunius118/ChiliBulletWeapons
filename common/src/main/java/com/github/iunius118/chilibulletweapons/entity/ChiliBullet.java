...
public class ChiliBullet extends Projectile {
    ...
    @Override
    public void shootFromRotation(Entity thrower, float rotX, float rotY, float elevation, float velocity,
                                  float inaccuracy) {
    ...
    public void tick() {
        ...
        while(!this.isRemoved()) {
            ...
            if (hitResult != null && hitResult.getType() != HitResult.Type.MISS
                    // ... and if this event is NOT canceled
                    && !Services.PLATFORM.shouldCancelProjectileImpact(this, hitResult)) {
    ...
    private int getCritDamage() {
        ...
        final double critDamageMultiplier =
                Constants.ChiliBulletGun.POWER_PIERCING * Constants.ChiliBulletGun.POWER_PIERCING;
