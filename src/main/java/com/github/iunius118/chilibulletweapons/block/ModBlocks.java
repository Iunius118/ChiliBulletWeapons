...
public class ModBlocks {
    ...
    public static final Block POTTED_CHILI_PEPPER_FLOWERING = new PottedChiliPepperBlock(() -> ModItems.CHILI_SEEDS, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY));
    public static final Block POTTED_CHILI_PEPPER_GREEN = new PottedChiliPepperBlock(() -> ModItems.CURVED_GREEN_CHILI, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY));
    public static final Block POTTED_CHILI_PEPPER_RED = new PottedChiliPepperBlock(() -> ModItems.CURVED_CHILI, BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY));
